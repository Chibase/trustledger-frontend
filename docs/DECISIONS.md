...
- **Consequences:** Operators set Vercel secrets, connect Zernio accounts, and add ClickUp statuses + webhook. Day-to-day interaction is the Platform Ops desk **`/ops/marketing`** (packet **MKT-2**), not the customer dashboard. Packet **MKT-1**. Runbook: `docs/MARKETING_ENGINE.md`.
