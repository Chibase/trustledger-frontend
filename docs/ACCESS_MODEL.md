...
- **Desk ranks (1 highest → 5 lowest):** Client/Board/funder → CEO/MD → Director/PM → Site foreman/supervisor → CLO. On **paid** plans, Plan Owner sits at the plan ceiling and may invite only **lower** ranks; higher desks stay greyed. **VIP** (complimentary Institutional) skips seat caps and desk-level gates so Owners can invite Client/Board and CEO seats freely — see `docs/VIP_ACCESS.md`.
