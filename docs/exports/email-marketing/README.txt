...
Brand: DESIGN_SYSTEM — ink #12202a, trust teal #0e7c66, paper #f3f5f7,
Source Serif wordmark (Georgia fallback), Chibase in footer only.

Files:
- _brand_header_snippet.html  Shared header pattern (ink + teal bar)
