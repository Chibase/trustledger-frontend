...
| **Local community intel** | Per project (tenant) | Ward surveys / CLO tallies uploaded in Capture → **Local community intel** — sits **beside** Stats SA to verify / support provincial figures and track local impact (`communityIntel.localIndicators`). Never writes into the platform pack. |
