...
## Part F — Where this lives in the product (optional follow-up)

| Placement | Idea |
|-----------|------|
| `/product` | “Watch onboarding (10 min)” button when a hosted video URL exists |
| Trial banner / Settings | Link for Plan Owners |
| WordPress Resources | Same URL |
| Email pack | Soft-launch / trial newsletter CTA |

Host the finished file on Vercel Blob, YouTube unlisted, or Webway media — keep the canonical link in Ops notes when published.
