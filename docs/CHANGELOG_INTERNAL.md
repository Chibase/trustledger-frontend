...
- Runtime constants in `src/lib/security/hosts.ts`. Footer, Themba, AEO FAQ, login/settings Cloud host, Resend preference, WordPress paste packs, `public/llms.txt`, and operational docs updated. CSP still allows the retired apex during cutover.
