...
- **Public brand ban:** Do not name Frappe, Vercel, HubSpot, Interserv, AccordBridge, or other stack vendors in marketing, FAQ, or public agents. Hosting = “TrustLedger Cloud” / “cloud”. Operator **Chibase Consulting** only in footer/legal/ops — never as a co-brand. Do not name **Version 001 / Version 002** or **TEDS** on public or customer surfaces (ADR-044) — use modules and plans.
