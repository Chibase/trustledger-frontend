...
### VIP guest enablement

| Packet | Name | Scope | Status |
|--------|------|-------|--------|
| **VIP-1** | VIP view + comment guests | ADR-037 — VIP Owners invite freely; invitees view-only + Comments profile; print/share locked; website export JSON | **Done** |
