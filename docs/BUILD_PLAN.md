...
| **SEC-SITE** | Dual-origin public hardening + Chibase site | ADR-046 — `/firm` brochure; CSP/HSTS/probe block; DNS cutover after WP cleanup; MX stays Webway (`docs/CHIBASE_SITE.md`, `docs/SITE_SECURITY.md`) | **Done** |
