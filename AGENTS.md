...
3. Current phase = **GO LIVE Done** + Cloud Stakeholder Intelligence deepening. Backend host = `app.trustledger.co.za` only (Interserv retired). Public marketing + product UI = Vercel at `trustledger.co.za` (WordPress brochure retired). No Cloudflare/WordPress work unless asked.
