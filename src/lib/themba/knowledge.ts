...
const CORE: ThembaKnowledgeItem[] = [
  ...
  },
  {
    ...
    sourceTitle: PRODUCT_SRC,
    answer:
      "Not on commercial plans yet. A briefing-to-SEP composer is still being built and is not included on Solo, Practitioner, Project, or Institutional — and it does not appear on trial or paying customer desks. Stakeholder Intelligence on entitled plans is the **registry**, **engagements**, and **commitments**. When the engagement-plan desk is ready it will ship as its own module. Until then, log people and meetings on those desks. Browse /product, or start a 14-day trial for the shipped SRM engine.",
    keywords: [
      "engagement plan",
      "sep",
      "rfp",
